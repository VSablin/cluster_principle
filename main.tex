...
\end{align}
The first term of the right hand side vanishes, since $a_\text{in}^\dagger(t)$ is a Heisenberg operator evaluated at time $t_-$ \cite{Fan2010,Xu2015}

{\color{blue}
\begin{enumerate}
\item Write input-output equations for the $\lambda$ atom (Appendix).
\item Show the relations for the commutators.
\end{enumerate}
}
