...
particles. Here, we study the conditions under the scattering is well defined. Besides, we analyze the linear part of the scattering matrix for
...
\end{align}
with $t_-\to-\infty$ and $t_+\to\infty$ {\color{blue}($H$ and $H_0$ should be defined in Section II)}. Provided the following conditions fulfil
\begin{align}
